# -*- coding: utf-8 -*-
"""Real_world_data_arabic.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1co_iJKBMzDdHvTJ9jTVRBOqBCtcMvlvd
"""
...
stream_train = pd.read_csv('Arabic_TRAIN_with_anomaly.csv',header=None)
stream = pd.read_csv('Arabic_TEST_with_anomaly.csv',header=None)
...
np.array(fddva_star)+300

np.std([93,83,120])

np.std([61,78,73])

np.array(add_trend_star)

np.array(add_star)+300

1/(8800-3)

len(ibdd_start)-2

np.array(ibdd_start)+300
