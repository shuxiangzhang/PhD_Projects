...
DRIFT = {}
for anomaly_rate in [0.02,0.04,0.06,0.08,0.1]:
...
#             print(vae_dd.drifts)
    ...
    DRIFT[anomaly_rate] = Drift
    file_name_1 = 'vae_dd_anomaly_rate_'+str(anomaly_rate)
    a_file = open(file_name_1, "w")
    json.dump(Drift, a_file)
    a_file.close()

file_name_1 = 'vae_dd_anomaly_rate_total_'+str(anomaly_rate)
a_file = open(file_name_1, "w")
json.dump(DRIFT, a_file)
a_file.close()
