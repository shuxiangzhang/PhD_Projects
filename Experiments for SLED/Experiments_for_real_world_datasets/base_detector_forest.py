...
project = Project("projects/single", "base_detector_forest"+ stream_name)

# 2. Generating training stream

project_path = "data_streams/base_detector_forest/" + stream_name + "/"
...
f = open('base_detector_forest.txt','a')
