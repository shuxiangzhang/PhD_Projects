...
project = Project("projects/single", "base_detector_mixed_gradual/"+ stream_name)

# 2. Generating training stream

project_path = "data_streams/base_detector_mixed_gradual/" + stream_name + "/"
...
for detector in d:
    ...
    for tm in range(repeat_count):
        ...
        stream_generator = MIXED(concept_length=5000, transition_length=800,noise_rate=0.1,num_drifts=30, random_seed=tm)
...
f = open('base_detector_mixed_gradual.txt','a')
