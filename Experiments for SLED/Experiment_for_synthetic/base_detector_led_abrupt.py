...
project = Project("projects/single", "base_detector_led_abrupt/"+ stream_name)

# 2. Generating training stream

project_path = "data_streams/base_detector_led_abrupt/" + stream_name + "/"
...
for detector in d:
    ...
    for tm in range(repeat_count):
        ...
        stream_generator = LEDConceptDrift(concept_length=5000, transition_length=5,led_attr_drift=led_attr_drift, random_seed=tm)
...
f = open('base_detector_led_abrupt_.txt','a')
