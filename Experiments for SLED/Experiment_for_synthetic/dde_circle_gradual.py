...
project = Project("projects/single", "dde_circle_gradual/"+ stream_name)

# 2. Generating training stream

project_path = "data_streams/dde_circle_gradual/" + stream_name + "/"
...
for detector in d:
    ...
    for tm in range(repeat_count):
        ...
        stream_generator = CIRCLES(concept_length=5000, transition_length=800, thresholds=thresholds, random_seed=tm)
...
f = open('dde_circle_gradual.txt', 'a')
