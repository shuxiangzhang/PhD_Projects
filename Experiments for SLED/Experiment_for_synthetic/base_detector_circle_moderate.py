...
project = Project("projects/single", "base_detector_circle_moderate/"+ stream_name)

# 2. Generating training stream

project_path = "data_streams/base_detector_circle_gradual_moderate/" + stream_name + "/"
...
for detector in d:
    ...
    for tm in range(repeat_count):
        ...
        stream_generator = CIRCLES(concept_length=5000, transition_length=500, noise_rate=0.1,thresholds=thresholds, random_seed=tm)
...
f = open('base_circle_moderate_.txt','a')
