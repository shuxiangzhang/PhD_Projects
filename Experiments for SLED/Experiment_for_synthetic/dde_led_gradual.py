...
project = Project("projects/single", "dde_led_gradual/" + stream_name)

# 2. Generating training stream

project_path = "data_streams/dde_led_gradual/" + stream_name + "/"
...
for detector in d:
    ...
    for tm in range(repeat_count):
        ...
        stream_generator = LEDConceptDrift(concept_length=5000, transition_length=800, led_attr_drift=led_attr_drift,
                                           random_seed=tm)
