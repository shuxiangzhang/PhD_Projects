...
stream_name = "circle"
project = Project("projects/single", "sled_circle_gradual_training/" + stream_name)

# 2. Generating training stream

project_path = "data_streams/sled_circle_gradual_training/" + stream_name + "/"
...
for final_w in fw:
    ...
    # Creating a project
    stream_name = "circle"
    project = Project("projects/single", "sled_circle_gradual_testing/" + stream_name)
    # Generating training stream

    project_path = "data_streams/sled_circle_gradual_testing/" + stream_name + "/"
    if not os.path.exists(project_path):
        os.makedirs(project_path)
    ...
    f = open('sled_circle_gradual.txt', 'a')
