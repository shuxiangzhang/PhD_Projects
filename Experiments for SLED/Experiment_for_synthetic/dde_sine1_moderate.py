...
project = Project("projects/single", "dde_sine1_moderate" + stream_name)

# 2. Generating training stream

project_path = "data_streams/dde_sine1_moderate/" + stream_name + "/"
...
for detector in d:
    ...
    for tm in range(repeat_count):
        ...
        stream_generator = SINE1(concept_length=5000, transition_length=500, num_drifts=30, random_seed=tm)
