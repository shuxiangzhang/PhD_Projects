...
project = Project("projects/single", "base_detector_led_moderate/"+ stream_name)

# 2. Generating training stream

project_path = "data_streams/base_detector_led_moderate/" + stream_name + "/"
...
for detector in d:
    ...
    for tm in range(repeat_count):
        ...
        stream_generator = LEDConceptDrift(concept_length=5000, transition_length=500,noise_rate=0.1,led_attr_drift=led_attr_drift, random_seed=tm)
