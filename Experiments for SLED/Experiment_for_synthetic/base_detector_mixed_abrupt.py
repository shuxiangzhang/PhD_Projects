...
project = Project("projects/single", "base_detector_mixed_abrupt/"+ stream_name)

# 2. Generating training stream

project_path = "data_streams/base_detector_mixed_abrupt/" + stream_name + "/"
...
for detector in d:
    ...
    for tm in range(repeat_count):
        ...
        stream_generator = MIXED(concept_length=5000, transition_length=5, num_drifts=30, noise_rate=0.1, random_seed=tm)
...
f = open('base_detector_mixed_abrupt.txt','a')
