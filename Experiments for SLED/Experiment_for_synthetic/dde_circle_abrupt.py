...
project = Project("projects/single", "dde_circle_abrupt/"+ stream_name)

# 2. Generating training stream

project_path = "data_streams/dde_circle_abrupt/" + stream_name + "/"
...
for detector in d:
    ...
    m_recall[detector.DETECTOR_NAME] = mean_recall

f = open('dde_circle_abrupt.txt', 'a')
